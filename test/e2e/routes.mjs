...
export const ROUTES = [
  ...
  { n: '12-bean-seattype', p: '/gz-bean/seat-type-config', t: '拼豆-座位类型配额', dialog: true },
  { n: '13-bean-booking', p: '/gz-bean/booking', t: '拼豆-预约管理' },
  { n: '14-bean-seat', p: '/gz-bean/seat', t: '拼豆-座位单元管理(ADR-0015)', dialog: true },
  { n: '15-bean-free-promo', p: '/gz-bean/free-promo', t: '拼豆-前N名免费促销(ADR-0015)', dialog: true },
  { n: '16-bean-board', p: '/gz-bean/board', t: '拼豆-店内计时看板(ADR-0015)' },
